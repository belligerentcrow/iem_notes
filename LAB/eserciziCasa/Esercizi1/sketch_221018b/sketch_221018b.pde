...
fill(90, 120, 60); 
circle(x2, y2+20, 30);
circle(x2-90, y2+40, 30); 
circle(x2+120, y2+30, 30); 
circle(x2-120, y2+120, 30);
circle(x2+70, y2+90, 30); 
circle(x2-40, y2+140, 30); 
circle(x2+20, y2+200, 30);
circle(x2, y2+180, 30); 
circle(x2-60, y2+240, 30); 
circle(x2+50, y2+320, 30); 
